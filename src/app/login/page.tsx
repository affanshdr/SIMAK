  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col lg:flex-row">
        ...
        <motion.div
          className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-yellow-400 to-yellow-200 relative overflow-hidden"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="flex flex-1 items-center justify-center p-6">
          ...
          >
            {/* Decorative elements */}
            <motion.div 
              className="absolute -top-20 -right-20 w-40 h-40 bg-yellow-300/20 rounded-full"
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            >
              ...
              <motion.h2 
                className="text-lg font-semibold text-yellow-600 mt-1"
                initial={{ y: 20 }}
                animate={{ y: 0 }}
                transition={{ delay: 0.6 }}
              >
            ...
            <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
              ...
              >
                ...
                {isSubmitting && (
                  <motion.span
                    className="absolute bottom-0 left-0 h-1 bg-yellow-600/30"
                    initial={{ width: 0 }}
                    animate={{ width: '100%' }}
